...
#plt.plot(fit_results.history["loss"], lable="Train")
#plt.plot(fit_results.history["val_loss"], lable="Validation")
#plt.legend()
#plt.show()

#plt.title("Accuracies train/validation")
#plt.plot(fit_results.history["accuracy"], lable="Train")
#plt.plot(fit_results.history["val_accuracy"], lable="Validation")
#plt.legend()
#plt.show()
